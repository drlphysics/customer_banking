...
def main():
    ...
    savings_maturity = float(input("Please enter the number of months for the savings account. "))
    ...
    # ADD YOUR CODE HERE
    print("Interest earned from savings account is", round(interest_earned, 2))
    print("The updated savings account balance is", round(updated_savings_balance, 2))
    ...
    # ADD YOUR CODE HERE
    print("Interest earned from savings account is", round(interest_earned, 2))
    print("The updated savings account balance is", round(updated_cd_balance, 2))
